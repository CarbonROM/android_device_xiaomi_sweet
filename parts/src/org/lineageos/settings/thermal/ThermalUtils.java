...
public final class ThermalUtils {
    ...
    protected static final int STATE_VIDEO_PLAYER = 6;
    ...
    private static final String THERMAL_STATE_VIDEO_PLAYER = "14";
    ...
    private static final String THERMAL_VIDEO_PLAYER = "thermal.video_player=";
    ...
    private String getValue() {
        ...
        if (value == null || value.isEmpty()) {
            value = THERMAL_BENCHMARK + ":" + THERMAL_BROWSER + ":" + THERMAL_CAMERA + ":" +
                    THERMAL_DIALER + ":" + THERMAL_GAMING + ":" + THERMAL_VIDEO_PLAYER;
            writeValue(value);
        }
        return value;
    }
